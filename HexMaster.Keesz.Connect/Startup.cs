...
using HexMaster.Keesz.Connect.Repositories;
using HexMaster.Keesz.Connect.Services;
...
namespace HexMaster.Keesz.Connect
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IKeeszConnectIntegrationEventService, KeeszConnectIntegrationEventService>();
            ...
            services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme)
                ...
                //    options.Authority = appSettings.IdentityServerUrl;
                //    options.RequireHttpsMetadata = false;
                //    options.ApiName = "api-connect";
                //    options.ApiSecret = "bfa787ac-f672-4b82-8051-2a0f2abfaf2d";
