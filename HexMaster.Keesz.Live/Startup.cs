...
using HexMaster.Keesz.Live.Configuration;
using HexMaster.Keesz.Live.IntegrationEvents.Events;
using HexMaster.Keesz.Live.IntegrationEvents.Handlers;
...
namespace HexMaster.Keesz.Live
{
    public class Startup
    {
        ...
        private void RegisterEventBus(IServiceCollection services, EventBusSettings settings)
        {
            ...
            services.AddTransient<FriendInvitationAcceptedEventHandler>();
            services.AddTransient<FriendInvitationReceivedEventHandler>();
        }

        protected virtual void ConfigureEventBus(IApplicationBuilder app)
        {
            var eventBus = app.ApplicationServices.GetRequiredService<IEventBus>();
            eventBus.Subscribe<FriendInvitationAcceptedEvent, FriendInvitationAcceptedEventHandler>();
            eventBus.Subscribe<FriendInvitationReceivedEvent, FriendInvitationReceivedEventHandler>();
        }
